...
public class UserAccountResource implements Serializable{
    ...
    public UserAccountResource(Builder build){
        this.id=build.id;
    ...
    public static class Builder{
        ...
        public Builder copy(UserAccountResource account){
        ...
        public UserAccountResource build(){return new UserAccountResource(this);}
    }
